...
# Axes a product can hang from. Filers use more than one.
_PRODUCT_AXES = ("ProductOrServiceAxis", "OilAndGasDeliveryAxis", "ProductAxis")
...
_PRODUCT_BY_MEMBER = {
    ...
    "OilMember": "oil",
    "CrudeOilAndNGLMember": "oil_and_ngl",
